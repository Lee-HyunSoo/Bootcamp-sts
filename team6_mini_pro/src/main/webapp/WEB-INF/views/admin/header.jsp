...
<script type="text/javascript" src="${contextPath}/resources/admin/js/product.js"  charset="UTF-8"></script>
...
<body onload="go_ab()">
	<div id="wrap">
		<header>
			...
			<input class="btn" type="button" value="logout" style="float: right;" onClick="location.href='${contextPath}/admin/members/adminLogout'">
		</header>
		<div class="clear"></div>
