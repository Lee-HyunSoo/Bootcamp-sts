...
<script type="text/javascript">
	function go_order_save(contextPath) {
		...
		if (count == 0) {
			...
			document.frm.action = contextPath + "/admin/orders/adminOrderSave";
			document.frm.submit();
		}
	}
	
	function go_search(contextPath) {
		document.frm.action = contextPath + "/admin/orders/adminOrderList";
		document.frm.submit();
	}
</script>
<article>
	...
	<form name="frm" method="post">
		...
		<input type="button" class="btn" style="width: 200px" value="주문처리(입금확인)" onClick="go_order_save('${contextPath}')">
	</form>
</article>
